...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(
        max_length=150, 
        unique=True, 
        validators=[MinLengthValidator(5, message="Username must be at least 5 characters long")],
...
class Notification(models.Model):
    ...
    actor = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='related_notifications')
